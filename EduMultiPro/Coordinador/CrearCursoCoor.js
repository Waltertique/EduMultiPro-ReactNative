...
export default function CrearCursoCoor({ navigation }) {
    ...
    const guardarCurso = async () => {
        ...
        navigation.navigate("PrincipalCoordinador"); // volver al listado
        } catch (error) {
        ...
        <View style={styles.contenedor}>
            ...
            <View style={styles.centroUsuario}>
                ...
                <View style={styles.tituloUsuario}>
                    ...
                    <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('PrincipalCoordinador')}>
