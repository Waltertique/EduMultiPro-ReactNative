...
export default function NoticiaCoor({ navigation }) {
    ...
    <View style={styles.contenedor}>
        ...
        <View style={styles.centroUsuario}>
            ...
            <View style={styles.tituloUsuario}>
                ...
                <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('CrearNoticiaCoor')}>
                    ...
                    <ScrollView horizontal>
                        ...
                        {filteredData.slice(from, to).map((noticia, index) => (
                            ...
                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonAccion} onPress={() => navigation.navigate('VerNoticiaCoor', { id: noticia.ID })}>
                                    <FontAwesome name="info" size={16} color="#fff" />
                                </TouchableOpacity>
                            </DataTable.Cell>

                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonModificar} onPress={() => navigation.navigate('ActualizarNoticiaCoor', { id: noticia.ID })}>
