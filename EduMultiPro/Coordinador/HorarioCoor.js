...
export default function HorarioCoor({ navigation }) {
    ...
    <View style={styles.contenedor}>
        ...
        <View style={styles.centroUsuario}>
            ...
            <View style={styles.tituloUsuario}>
                ...
                <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('CrearHorarioCoor')}>
                    ...
                    <ScrollView horizontal>
                        ...
                        {filteredData.slice(from, to).map((horario, index) => (
                            ...
                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonAccion} onPress={() => navigation.navigate('VerHorarioCoor', { id: horario.ID })}>
                                    <FontAwesome name="info" size={16} color="#fff" />
                                </TouchableOpacity>
                            </DataTable.Cell>

                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonModificar} onPress={() => navigation.navigate('ActualizarHorarioCoor', { id: horario.ID })}>
