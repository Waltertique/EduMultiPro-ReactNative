...
export default function TrabajoProfesor({ navigation, route }) {
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center' }}>
                ...
                <View style={styles.centroProfeso}>
                    ...
                    <View style={styles.tituloTrabajo}>
                        ...
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate('VerAulaProfesor', { id })}>
                            <Text style={styles.textoControlAula}> Inicio</Text>
                        </TouchableOpacity>
    
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate('TrabajoProfesor', { id })}>
                            <Text style={styles.textoControlAula}> Trabajos</Text>
                        </TouchableOpacity>
    
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate('NotaProfesor', { id })}>
                            <Text style={styles.textoControlAula}> Notas</Text>
                        </TouchableOpacity>
    
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate("PersonaProfesor", { id })}>
                    ...
                    <View style={styles.tituloUsuario}>
                        ...
                        <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('CrearTrabajoProfesor', { id })}>
                        ...
                        <View style={styles.container}>
                            ...
                            <ScrollView horizontal>
                                ...
                                {filteredData.slice(from, to).map((trabajo, index) => (
                                    ...
                                    <DataTable.Cell style={styles.tablaBody}>
                                        <TouchableOpacity style={styles.botonModificar} onPress={() => navigation.navigate('ActualizarTrabajoProfesor', { id: trabajo.ID })}>
