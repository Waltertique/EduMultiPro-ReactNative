...
export default function VerTrabajoEntregadoPro({ navigation }) {
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center' }}>
                ...
                <View style={styles.centroProfeso}>
                    ...
                    <View style={styles.tituloTrabajo}>
                        ...
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate('VerTrabajoProfesor', { id, aula_id })}>
                            <Text style={styles.textoControlAula}> Trabajo</Text>
                        </TouchableOpacity>
    
                        <TouchableOpacity style={styles.botonControlAula} onPress={() => navigation.navigate('VerTrabajoEntregadoPro')}>
