...
export default function CrearTrabajoProfesor({ navigation }) {
    ...
    const handleCrearTrabajo = async () => {
        ...
        if (res.ok) {
            navigation.navigate("TrabajoProfesor", { id }); // volver a trabajos
        }
        } catch (error) {
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center' }}>
                ...
                <View style={styles.centroProfeso}>
                    ...
                    <View style={styles.tituloUsuario}>
                        ...
                        <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate("TrabajoProfesor", { id })}>
