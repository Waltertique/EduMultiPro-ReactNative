...
import RutasProfesor from './Profesor/RutasProfesor';
import RutasAlumno from './Alumno/RutasAlumno';
      ...
      if (response.ok) {
        ...
        switch (rol) {
          ...
          case "R003":
            ...
            break;
          case "R002":
            navigation.replace("RutasProfesor");
            break;
          case "R001":
            navigation.replace("RutasAlumno");
            break;
          default:
