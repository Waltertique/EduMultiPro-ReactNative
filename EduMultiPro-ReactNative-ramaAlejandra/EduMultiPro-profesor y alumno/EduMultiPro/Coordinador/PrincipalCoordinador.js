...
export default function PrincipalCoordinador({ navigation }) {
    ...
    <View style={styles.contenedor}>
        ...
        <View style={styles.centroUsuario}>
            ...
            <View style={styles.BotonesPlataforma}>
                ...
                <TouchableOpacity style={styles.botonPlataforma} onPress={() => navigation.navigate('MateriaCoor')}>
                    <FontAwesome5 name="book" size={16} color={colors.azulPrimario} />
                    <Text style={styles.textobotonPlataforma}> Materias</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.botonPlataforma} onPress={() => navigation.navigate('GradoCoor')}>
                    <FontAwesome5 name="temperature-low" size={16} color={colors.azulPrimario} />
                    <Text style={styles.textobotonPlataforma}> Grados</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.botonPlataforma} onPress={() => navigation.navigate('JornadaCoor')}>
            ...
            <View style={styles.tituloUsuario}>
                ...
                <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('CrearCursoCoor')}>
                    ...
                    <ScrollView horizontal>
                        ...
                        <DataTable.Row key={index}>
                            ...
                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonAccion} onPress={() => navigation.navigate('VerCursoCoor', { id: curso.ID })}>
