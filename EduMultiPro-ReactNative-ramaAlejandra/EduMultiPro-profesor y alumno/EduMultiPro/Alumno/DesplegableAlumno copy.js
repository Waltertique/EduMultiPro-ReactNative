...
import colors from "../colors"; // 👈 asegúrate de la ruta correcta

// 👉 Opciones del menú basadas en RutasAlumno.js (limpiado)
const opciones = [
  ...
  { name: "Clases", icon: "chalkboard-teacher", route: "ClaseAlumno" },
  { name: "Perfil", icon: "user", route: "PerfilAlumno" },
  { name: "Salir", icon: "sign-out-alt", route: "Login" }, // ⚠️ Login debe estar definido en tu App.js
];
