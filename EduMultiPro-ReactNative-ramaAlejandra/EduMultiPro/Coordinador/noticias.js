    ...
    <View style={styles.contenedor}>
        ...
        <View style={styles.centroUsuario}>
            ...
            <View style={styles.tituloUsuario}>
                ...
                <TouchableOpacity style={styles.botonCrearUsuario} onPress={() => navigation.navigate('crearNoticias')}>
                    ...
                    <ScrollView horizontal>
                        ...
                        {filteredData.slice(from, to).map((Noticia, index) => (
                            ...
                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonAccion} onPress={() => navigation.navigate('verNoticias')}>
                                    <FontAwesome name="info" size={16} color="#fff" />
                                </TouchableOpacity>
                            </DataTable.Cell>

                            <DataTable.Cell style={styles.tablaBody}>
                                <TouchableOpacity style={styles.botonModificar} onPress={() => navigation.navigate('modNoticias')}>
